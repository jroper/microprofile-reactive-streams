 ...
 * provided in a deployment returned by {@link TckContainer#createDeployments(java.util.Collection)}, to allow it to be dependency injected into the
 * tests running in the container, so they can control topics and query them for results.
 */
